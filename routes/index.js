...
res.render('index', { title: 'MusicalInstruments App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'MusicalInstruments App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'MusicalInstruments App Login', user : req.user });
  });
